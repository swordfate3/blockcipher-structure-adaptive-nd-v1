...
set RUN_ID=i1_present_autond_dbitnet_r1a_valloss_65k_seed0_gpu1_20260710
...
"%PYTHON_EXE%" scripts\check-remote-readiness --config configs\remote\innovation1_spn_present_autond_dbitnet_r1a_valloss_65k_seed0_gpu1_20260710.json > "%LOG_DIR%\%RUN_ID%_readiness.txt" 2> "%LOG_DIR%\%RUN_ID%_readiness_stderr.txt" || goto failed
