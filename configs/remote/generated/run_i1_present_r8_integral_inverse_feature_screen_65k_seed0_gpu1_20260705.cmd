...
set RUN_ID=i1_present_r8_integral_inverse_feature_screen_65k_seed0_gpu1_20260705
...
"%PYTHON_EXE%" scripts\check-remote-readiness --config configs\remote\innovation1_spn_present_r8_integral_inverse_feature_screen_65k_seed0_gpu1_20260705.json > "%LOG_DIR%\%RUN_ID%_readiness.txt" 2> "%LOG_DIR%\%RUN_ID%_readiness_stderr.txt" || goto failed
