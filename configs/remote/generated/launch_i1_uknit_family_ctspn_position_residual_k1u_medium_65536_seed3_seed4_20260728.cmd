...
set TASK_NAME=I1_UKNIT_K1U_S3S4_GPU1
set SCHEDULE_CMD=%SCHEDULE_ROOT%\i1_uknit_k1u_seed3_seed4_gpu1.cmd
...
set RUN_CMD=%RUNS_ROOT%\%RUN_ID%\source\configs\remote\generated\run_i1_uknit_family_ctspn_position_residual_k1u_medium_65536_seed3_seed4_20260728.cmd
>"%SCHEDULE_CMD%" echo @echo off
>>"%SCHEDULE_CMD%" echo call "%RUN_CMD%" 1
