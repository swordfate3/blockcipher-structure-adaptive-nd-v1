...
set RUN_ID=i1_present_r8_pair_evidence_pooling_screen_65k_seed0_gpu0_20260705
...
set DATASET_CACHE_ROOT=G:\lxy\blockcipher-structure-adaptive-nd-runs\pair_evidence_pooling_screen_r8_65k_cache
...
"%PYTHON_EXE%" scripts\check-remote-readiness --config configs\remote\innovation1_spn_present_pair_evidence_pooling_screen_r8_65k_seed0_gpu0_20260705.json > "%LOG_DIR%\%RUN_ID%_readiness.txt" 2> "%LOG_DIR%\%RUN_ID%_readiness_stderr.txt" || goto failed
...
"%PYTHON_EXE%" scripts\train ^
  ...
  --progress-output "%LOG_DIR%\pair_evidence_pooling_screen_progress.jsonl" ^
