...
set TASK_NAME=I1_DIALGA_DFC1_S0S1_GPU0
set SCHEDULE_CMD=%SCHEDULE_ROOT%\i1_dialga_dfc1_seed0_seed1_gpu0.cmd
...
if exist "%LAUNCH_LOG_DIR%\%RUN_ID%_launched.marker" exit /b 9
...
if exist "%RUN_ROOT%\logs\%RUN_ID%_done.marker" exit /b 9
if exist "%RUN_ROOT%\logs\%RUN_ID%_failed.marker" exit /b 9
if exist "%RUN_ROOT%\logs\%RUN_ID%_raw_ready.marker" exit /b 9
