...
set PLAN=configs\experiment\innovation1\innovation1_spn_rectangle80_runtime_e4_scale_rct3_262144_seed0.csv
set REMOTE_CONFIG=configs\remote\innovation1_rct3_rectangle80_runtime_e4_scale_262144_seed0_gpu1_20260727.json
...
"%PY%" scripts\gate-runtime-spn-rectangle-medium ^
  --run-id "%RUN_ID%" ^
...
git commit -m "results: %RUN_ID% remote scale confirmation" > "%LOG_DIR%\%RUN_ID%_result_branch_commit.txt" 2>&1 || goto failed
