...
set RUN_ID=i1_pairset_aggregation_control_r8_262k_seed0_gpu0_20260705
set STAGE_A_ID=i1_pairset_single_pair_scorer_r8_262k_seed0_gpu0_20260705
...
set DATASET_CACHE_ROOT=G:\lxy\blockcipher-structure-adaptive-nd-runs\round_extension_r8_pairset_control_cache
...
"%PYTHON_EXE%" scripts\train ^
  --plan configs\experiment\innovation1\innovation1_spn_present_pairset_aggregation_control_single_pair_r8_262k.csv ^
  --epochs 20 ^
  --batch-size 1024 ^
  --hidden-bits 32 ^
  --device cuda:0 ^
...
"%PYTHON_EXE%" scripts\evaluate-pairset-aggregation ^
  ...
  --eval-plan configs\experiment\innovation1\innovation1_spn_present_pairset_aggregation_control_r8_262k.csv ^
  --eval-row-index 0 ^
