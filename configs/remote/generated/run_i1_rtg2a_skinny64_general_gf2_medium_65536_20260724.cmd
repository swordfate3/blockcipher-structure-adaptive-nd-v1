...
if not "%SEED%"=="0" if not "%SEED%"=="1" goto invalid_arguments
...
set PLAN=configs\experiment\innovation1\innovation1_spn_skinny64_runtime_e4_medium_rtg2a_65536_seed%SEED%.csv
set REMOTE_CONFIG=configs\remote\innovation1_rtg2a_skinny64_general_gf2_medium_65536_seed%SEED%_gpu0_20260724.json
...
git commit -m "results: %RUN_ID% remote medium replication" > "%LOG_DIR%\%RUN_ID%_result_branch_commit.txt" 2>&1 || goto failed
