...
SUMMARY="${LOCAL_ROOT}/results/trail_family_cache_bench/summary.json"
...
sync_artifacts() {
  ...
  mkdir -p "${LOCAL_ROOT}/results/trail_family_cache_bench"
  scp "${REMOTE}:${REMOTE_RUN_ROOT}/results/trail_family_cache_bench/summary.json" \
    "${LOCAL_ROOT}/results/trail_family_cache_bench/summary.json" \
