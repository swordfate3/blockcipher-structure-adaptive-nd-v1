...
set TASK_NAME=I1_FEISTEL_SM4_POSITION_RESNET_2048_GPU1
set SOURCE_COMMIT=%~1
...
set RUN_CMD=%SOURCE_ROOT%\configs\remote\generated\run_i1_feistel_sm4_position_resnet_calibration_2048_20260715.cmd
schtasks /Create /TN "%TASK_NAME%" /SC ONCE /ST 23:59 /RU SYSTEM /RL HIGHEST /TR "cmd.exe /c %RUN_CMD% 1" /F > "%LAUNCH_LOG_DIR%\%RUN_ID%_schedule_create.txt" 2>&1 || exit /b 1
