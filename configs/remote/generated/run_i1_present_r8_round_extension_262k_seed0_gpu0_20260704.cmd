...
set RUN_ID=i1_present_r8_round_extension_262k_seed0_gpu0_20260704
...
set DATASET_CACHE_ROOT=G:\lxy\blockcipher-structure-adaptive-nd-runs\round_extension_r8_cache
...
"%PYTHON_EXE%" scripts\check-remote-readiness --config configs\remote\innovation1_spn_present_round_extension_r8_262k_seed0_gpu0_20260704.json > "%LOG_DIR%\%RUN_ID%_readiness.txt" 2> "%LOG_DIR%\%RUN_ID%_readiness_stderr.txt" || goto failed
...
"%PYTHON_EXE%" scripts\train ^
  ...
  --progress-output "%LOG_DIR%\round_extension_progress.jsonl" ^
