...
set RUN_ID=i1_pairset_aggregation_control_r7_262k_seed0_gpu1_20260630
set STAGE_A_ID=i1_pairset_single_pair_scorer_r7_262k_seed0_gpu1_20260630
...
"%PYTHON_EXE%" scripts\train ^
  --plan configs\experiment\innovation1\innovation1_spn_present_pairset_aggregation_control_single_pair_r7_262k.csv ^
  --epochs 20 ^
  --batch-size 1024 ^
  --hidden-bits 32 ^
  --device cuda:1 ^
...
"%PYTHON_EXE%" scripts\evaluate-pairset-aggregation ^
  ...
  --eval-plan configs\experiment\innovation1\innovation1_spn_present_pairset_aggregation_control_r7_262k.csv ^
  --eval-row-index 0 ^
