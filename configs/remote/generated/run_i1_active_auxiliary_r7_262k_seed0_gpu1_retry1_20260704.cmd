...
set RUN_ID=i1_active_auxiliary_r7_262k_seed0_gpu1_retry1_20260704
...
"%PYTHON_EXE%" scripts\check-remote-readiness --config configs\remote\innovation1_spn_present_active_auxiliary_r7_262k_seed0_gpu1_retry1_20260704.json > "%LOG_DIR%\%RUN_ID%_readiness.txt" 2> "%LOG_DIR%\%RUN_ID%_readiness_stderr.txt" || goto failed
echo started>"%LOG_DIR%\%RUN_ID%_started.marker"

"%PYTHON_EXE%" scripts\spn-active-auxiliary-matrix ^
  --config configs\experiment\innovation1\innovation1_spn_present_active_auxiliary_r7_262k_seed0_retry1.json ^
