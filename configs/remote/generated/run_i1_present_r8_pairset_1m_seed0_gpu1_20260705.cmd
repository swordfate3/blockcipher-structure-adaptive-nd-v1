...
set RUN_ID=i1_present_r8_pairset_1m_seed0_gpu1_20260705
...
set DATASET_CACHE_ROOT=G:\lxy\blockcipher-structure-adaptive-nd-runs\round_extension_r8_1m_cache
...
"%PYTHON_EXE%" scripts\check-remote-readiness --config configs\remote\innovation1_spn_present_pairset_r8_1m_seed0_gpu1_20260705.json > "%LOG_DIR%\%RUN_ID%_readiness.txt" 2> "%LOG_DIR%\%RUN_ID%_readiness_stderr.txt" || goto failed
...
"%PYTHON_EXE%" scripts\train ^
  ...
  --progress-output "%LOG_DIR%\r8_pairset_1m_progress.jsonl" ^
