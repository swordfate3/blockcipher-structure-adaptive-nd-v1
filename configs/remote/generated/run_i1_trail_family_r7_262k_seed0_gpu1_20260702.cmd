...
set RUN_ID=i1_trail_family_r7_262k_seed0_gpu1_20260702
...
set FEATURE_CACHE_ROOT=G:\lxy\blockcipher-structure-adaptive-nd-runs\trail_family_cache
...
"%PYTHON_EXE%" scripts\check-remote-readiness --config configs\remote\innovation1_spn_present_trail_family_r7_262k_seed0_gpu1_20260702.json > "%LOG_DIR%\%RUN_ID%_readiness.txt" 2> "%LOG_DIR%\%RUN_ID%_readiness_stderr.txt" || goto failed
echo started>"%LOG_DIR%\%RUN_ID%_started.marker"

"%PYTHON_EXE%" scripts\spn-trail-family-matrix ^
  --config configs\experiment\innovation1\innovation1_spn_present_trail_family_r7_262k_seed0.json ^
