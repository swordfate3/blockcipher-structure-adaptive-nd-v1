...
PLAN="configs/experiment/innovation1/innovation1_spn_present_active_auxiliary_r7_262k_seed1.json"
PLAN_DOC="docs/experiments/innovation1-active-pattern-auxiliary-head-plan.md"
REMOTE_CONFIG="configs/remote/innovation1_spn_present_active_auxiliary_r7_262k_seed1_gpu1_20260703.json"
EXPECTED_ROWS="3"
