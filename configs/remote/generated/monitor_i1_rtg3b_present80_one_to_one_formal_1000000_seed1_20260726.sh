...
LAUNCH_SCRIPT="configs\\remote\\generated\\launch_i1_rtg3b_present80_one_to_one_formal_1000000_seed1_20260726.cmd"
...
SOURCE_COMMIT="${1:-}"
LAUNCH_GATE_PATH="${2:-outputs/local_readiness/i1_rtg3b_present80_one_to_one_formal_1000000_seed1_launch_gate_20260726/gate.json}"
