...
set RUN_ID=i1_spn_topology_aware_network_r7_262k_seed1_gpu1_accel_bf16_20260701
...
echo speed_profile=amp-bf16>>"%LOG_DIR%\%RUN_ID%_launch_env.txt"
...
set PYTHONPATH=%PROJECT_ROOT%\plugins\blockcipher-training-accelerator\src;%PROJECT_ROOT%\src
"%PYTHON_EXE%" -m blockcipher_training_accelerator run-accelerated -- ^
