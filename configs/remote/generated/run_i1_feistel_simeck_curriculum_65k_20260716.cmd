...
set RUN_ID=i1_feistel_simeck_curriculum_65k_seed0
...
set PLAN=configs\experiment\innovation1\innovation1_feistel_simeck_curriculum_scale_probe_65536_seed0.csv
set REMOTE_CONFIG=configs\remote\innovation1_feistel_simeck_curriculum_65k_seed0_gpu0_20260716.json
...
"%PY%" scripts\gate-feistel-balanced ^
  --plan "%PLAN%" ^
  --results "%RESULTS_DIR%\results.jsonl" ^
...
"%PY%" scripts\plot-results ^
  ...
  --title "Innovation 1 SIMECK r14-to-r15 curriculum 65536 per class" ^
...
git commit -m "results: %RUN_ID% medium scale" > "%LOG_DIR%\%RUN_ID%_result_branch_commit.txt" 2>&1 || goto failed
