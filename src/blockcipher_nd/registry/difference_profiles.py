...
def literature_difference_profiles() -> dict[str, DifferenceProfile]:
    return {
        ...
        "simon64_lu2024_ordinary": DifferenceProfile(
            name="simon64_lu2024_ordinary",
            cipher="simon64",
            kind="fixed",
            differences=(0x0000000000000040,),
            word_difference=("0x00000000", "0x00000040"),
            source="Lu et al. 2024 ordinary-key SIMON64/128 neural distinguisher",
            note="Eight same-key pairs per sample with plaintext xor difference (0,0x40).",
            pairs_per_sample=8,
        ),
        "simeck64_lu2024_ordinary": DifferenceProfile(
            name="simeck64_lu2024_ordinary",
            cipher="simeck64",
            kind="fixed",
            differences=(0x0000000000000040,),
            word_difference=("0x00000000", "0x00000040"),
            source="Lu et al. 2024 ordinary-key SIMECK64/128 neural distinguisher",
            note="Eight same-key pairs per sample with plaintext xor difference (0,0x40).",
            pairs_per_sample=8,
        ),
