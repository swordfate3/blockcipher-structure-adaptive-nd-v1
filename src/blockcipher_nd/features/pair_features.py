...
def encode_ciphertext_pair(
    ...
    *,
    ...
    present_encoders = {
        ...
        "present_delta_paligned_sinv_sboxddt_beamstats8deep4_maskedsource_cell_matrix_bits": lambda: present_delta_paligned_sinv_sboxddt_beamstats8deep4_maskedsource_cell_matrix_bits(left, right, width, cipher),
        "present_delta_paligned_sinv_sboxddt_beamstats8deep4_constantsource_cell_matrix_bits": lambda: present_delta_paligned_sinv_sboxddt_beamstats8deep4_constantsource_cell_matrix_bits(left, right, width, cipher),
...
def pair_bits_for_encoding(block_bits: int, feature_encoding: str) -> int:
    ...
    widths = {
        ...
        "present_delta_paligned_sinv_sboxddt_beamstats8deep4_maskedsource_cell_matrix_bits": 39,
        "present_delta_paligned_sinv_sboxddt_beamstats8deep4_constantsource_cell_matrix_bits": 39,
