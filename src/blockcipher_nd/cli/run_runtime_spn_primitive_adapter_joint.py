...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description=(
            "Train and adjudicate one shared Runtime-E4 primitive-adapter checkpoint "
...
def main(argv: list[str] | None = None) -> int:
    ...
    config = load_and_validate_joint_config(args.config)
