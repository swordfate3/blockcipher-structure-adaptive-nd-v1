...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the fail-closed RECTANGLE RCT3 SSH authorization gate."
    )
    parser.add_argument("--rct2-root", required=True, type=Path)
...
def main(argv: list[str] | None = None) -> int:
    ...
    gate = build_runtime_spn_rectangle_rct3_launch_gate(
        rct2_root=args.rct2_root,
