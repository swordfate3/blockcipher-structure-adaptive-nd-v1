...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Gate uKNIT K1-CA closeout results.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.run_id != RUN_ID:
        raise ValueError(f"K1-CA run_id must remain frozen as {RUN_ID}")
    ...
    gate = adjudicate(
        ...
        source_checks={
            ...
            "four_nonempty_checkpoints_present": len(checkpoints)
            == EXPECTED_RESULT_ROWS
