...
SOURCE_FILES = (
    "configs/experiment/innovation1/innovation1_uknit_r5_k1ca_invariant_autond_closeout_262144_seed3_seed4.csv",
    "configs/remote/innovation1_uknit_k1ca_invariant_autond_closeout_262144_seed3_seed4_gpu0_20260803.json",
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Package the remote uKNIT K1-CA archive."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = package_archive(
        ...
        claim_scope=(
            "remote two-seed 262144/class uKNIT r5 project-protocol paper "
            "closeout; not exact AutoND reproduction or formal million-scale evidence"
        ),
    )
