...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Adjudicate Dialga-128 Runtime-E4 D1 two-seed attribution."
    )
...
def main(argv: list[str] | None = None) -> int:
    ...
    gate = adjudicate_runtime_spn_dialga_d1(run_id=args.run_id, rows=rows)
    validation = {
        "run_id": args.run_id,
    ...
    summary = {
        "run_id": args.run_id,
        "task": "innovation1_dialga128_runtime_e4_d1_r4_attribution",
