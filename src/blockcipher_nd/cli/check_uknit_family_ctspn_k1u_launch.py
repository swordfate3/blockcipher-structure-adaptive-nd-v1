...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Run the fail-closed uKNIT K1-U remote launch gate."
    )
    parser.add_argument("--k1t-root", required=True, type=Path)
...
def main(argv: list[str] | None = None) -> int:
    ...
    gate = build_k1u_launch_gate(
        k1t_root=args.k1t_root,
