...
def _residual_watch_command(
    *,
    ...
    parts = [
        ...
        "uv",
        "run",
        "scripts/watch-residual-focus-results",
        "--action-plan",
        str(action_plan),
        "--gate-output",
        str(gate_output),
...
def _compact_monitor_progress(value: object) -> dict[str, Any]:
    ...
    keys = [
        ...
        "cache_eta_seconds",
        "cache_input_bits",
        "cache_pairs_per_sample",
        "cache_pair_bits",
        "cache_rows_done_feature_bits",
        "cache_total_feature_bits",
        "cache_rows_done_feature_bytes",
        "cache_total_feature_bytes",
        "epoch",
        "epochs",
        "val_auc",
...
def main(argv: list[str] | None = None) -> int:
    ...
    report = summarize_present_r8_diverse_route(
        ...
        watch_command=_residual_watch_command(
            action_plan=args.residual_action_plan,
            gate_output=args.residual_gate,
            pool_output=args.pool_plan,
            pool_eval_output=args.pool_eval,
