...
- The user prefers detailed, hand-calculable data examples over an abstract summary.
- Always separate within-ciphertext mask parity, within-one-structure integral XOR, and cross-key empirical rate. Avoid the ambiguous phrase "across structure"; say "XOR all plaintext observations inside one structure."
