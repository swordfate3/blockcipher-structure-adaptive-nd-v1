...
状态：核心全文与联网核验完成 / OPA3正式hold / 精确P-layer创新主张删除
...
1. 把OPA3 exact/identity/wrong-P结果和`hold`裁决加入论文核心表，保留verified result branch与视觉
   质检证据。
2. 关闭OPA4/OPA5，不通过错误排列搜索、seed、数据、epoch或网络枚举绕过归因门。
3. 在最终使用“新方法”措辞前，核验联网检索新增候选的实际落地页和全文，并把任务不同的BiLSTM、
