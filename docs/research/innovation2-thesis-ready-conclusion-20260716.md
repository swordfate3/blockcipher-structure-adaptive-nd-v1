...
> 历史状态说明（2026-07-19）：本文只保留E0--E6的r5先导结果与位置先验负归因，已经不是
> 创新2的最终结论。PRESENT/GIFT双密码PG-NBPO正式方法、架构组合边界和E97高轮标签provider
> 边界已综合到`docs/research/innovation2-thesis-consolidation-20260719.md`。论文正文应以新综合稿
> 为主，本文仅作为“早期任务构造与强基线审计”历史证据，不得单独代表创新2当前状态。
