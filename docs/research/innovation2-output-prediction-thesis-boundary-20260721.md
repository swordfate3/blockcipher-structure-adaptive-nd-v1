...
状态：OP9--OPC1与OPN1完成 / OPC1全局头混合路线hold并停止 / 四轮关闭
...
可识别。该新假设必须保持PRESENT三轮、八个冻结bit、`2^17/2^16`和100 epochs不变，以普通ResCNN、
无路由位置头、wrong-P和shuffle为控制；先过确定性参数/可识别性与本地readiness门，再决定远程执行。
